-- Atualiza get_company_feature_flags para incluir todas as features do sistema
...
-- Atualiza company_feature_enabled para incluir defaults das novas features por plano
