ALTER TABLE public.companies
  ADD COLUMN IF NOT EXISTS large_party_whatsapp_threshold integer NOT NULL DEFAULT 10;

ALTER TABLE public.companies
  ADD COLUMN IF NOT EXISTS reservation_late_tolerance_minutes integer NOT NULL DEFAULT 10;

ALTER TABLE public.companies
  ALTER COLUMN large_party_whatsapp_threshold SET DEFAULT 10;

ALTER TABLE public.companies
  ALTER COLUMN reservation_late_tolerance_minutes SET DEFAULT 10;

UPDATE public.companies
SET large_party_whatsapp_threshold = 10
WHERE large_party_whatsapp_threshold IS NULL;

UPDATE public.companies
SET reservation_late_tolerance_minutes = 10
WHERE reservation_late_tolerance_minutes IS NULL;

ALTER TABLE public.companies
  ALTER COLUMN large_party_whatsapp_threshold SET NOT NULL;

ALTER TABLE public.companies
  ALTER COLUMN reservation_late_tolerance_minutes SET NOT NULL;

ALTER TABLE public.companies
  DROP CONSTRAINT IF EXISTS companies_large_party_whatsapp_threshold_check;

ALTER TABLE public.companies
  DROP CONSTRAINT IF EXISTS companies_reservation_late_tolerance_minutes_check;

ALTER TABLE public.companies
  ADD CONSTRAINT companies_large_party_whatsapp_threshold_check
  CHECK (large_party_whatsapp_threshold BETWEEN 2 AND 20);

ALTER TABLE public.companies
  ADD CONSTRAINT companies_reservation_late_tolerance_minutes_check
  CHECK (reservation_late_tolerance_minutes BETWEEN 0 AND 120);
