...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_whatsapp_message_logs_company_reservation_sent
  ON public.whatsapp_message_logs(company_id, reservation_id, created_at)
